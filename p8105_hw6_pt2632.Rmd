...
mlr$rank
```
The rank of MLR model doesn't equal to the count of predictors for fitting model, indicating that the variable with `NA` as coefficient estimate is with colinearity to other variable. So we should discard this variable because it provide redundant information.
